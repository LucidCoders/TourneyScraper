...
public class TourneyDetailsBuilder {
    ...
    private AtlasDetailsResponse mDetailsResponse;
    private String mUrl;

    public TourneyDetailsBuilder (AtlasDetailsResponse detailsResponse, String url) {
	mDetailsResponse = detailsResponse;
	mUrl = url;
    }
    
    public TourneyDetails build() {
	...
	for (Result eachResult : mDetailsResponse.getResults()) {
